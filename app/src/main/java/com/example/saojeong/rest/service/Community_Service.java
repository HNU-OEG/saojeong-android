...
public interface Community_Service {
    ...
    Call<List<Community_CreateBoardPostDto>> CreatePost(@Query("title")String title);
    ...
    Call<List<CommunityDto>> LikePost(@Field("type") String title, @Field("task") String down);
}
