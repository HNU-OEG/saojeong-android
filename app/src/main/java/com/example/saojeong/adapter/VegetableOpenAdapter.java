...
public class VegetableOpenAdapter extends RecyclerView.Adapter<VegetableOpenAdapter.ViewHolder> implements OnItemClickListener<VegetableOpenAdapter.ViewHolder> {
